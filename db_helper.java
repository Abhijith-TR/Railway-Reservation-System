...
// IN train_number character varying, IN dep_date date, IN ac_coaches integer, IN sl_coaches integer
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(bookTickets(conn, "115", "2022-12-12", "AC", names, ages, genders));
            conn.close();
